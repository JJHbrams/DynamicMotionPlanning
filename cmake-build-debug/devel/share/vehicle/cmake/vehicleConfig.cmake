...
if("TRUE" STREQUAL "TRUE")
  set(vehicle_SOURCE_PREFIX /home/mrjohd/MotionPlanning_ws/src/DynamicMotionPlanning/vehicle)
  set(vehicle_DEVEL_PREFIX /home/mrjohd/MotionPlanning_ws/src/cmake-build-debug/devel)
  set(vehicle_INSTALL_PREFIX "")
  set(vehicle_PREFIX ${vehicle_DEVEL_PREFIX})
else()
  set(vehicle_SOURCE_PREFIX "")
  set(vehicle_DEVEL_PREFIX "")
  set(vehicle_INSTALL_PREFIX /usr/local)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://moveit.ros.org/ " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'JJH <mrjohd@kaist.ac.kr>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vehicle' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mrjohd/MotionPlanning_ws/src/DynamicMotionPlanning/vehicle/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT vehicle_NUM_DUMMY_TARGETS)
      set(vehicle_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::vehicle::wrapped-linker-option${vehicle_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR vehicle_NUM_DUMMY_TARGETS "${vehicle_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::vehicle::wrapped-linker-option${vehicle_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND vehicle_LIBRARIES "${interface_target_name}")
